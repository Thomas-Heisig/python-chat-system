...
class LoRATrainingConfig:
    ...
    def from_hyperparameters(cls, *, base_model_id: str, job_id: str, hyperparameters: dict[str, object]) -> "LoRATrainingConfig":
        ...
        return cls(
            ...
            max_sequence_length=max(128, int(hyperparameters.get("max_sequence_length", 2048))),
            ...
            target_modules=[str(item) for item in (hyperparameters.get("target_modules") or ["q_proj", "k_proj", "v_proj", "o_proj"])],
